...
Shader "#NVJOB/SC Shaders (Legacy)/Transparent, Normalmap, Reflection, Cull Off" {
...
LOD 200
CGPROGRAM
#pragma surface surf BlinnPhong alpha:fade exclude_path:prepass nolppv noforwardadd interpolateview novertexlights
