...
Shader "#NVJOB/SC Shaders (Legacy)/Cutout, Normalmap, Reflection, Cull Off" {
...
half _Cutoff, _Shininess, _BiasNormal, _IntensityNm, _IntensityRef, _Saturation, _Contrast, _Brightness;
samplerCUBE _Cube;
