...
Shader "#NVJOB/SC Shaders (Legacy)/Normalmap, Occlusion, Reflection, Cull Off" {
...
half _Shininess, _BiasNormal, _IntensityNm, _OcclusionMapUv, _IntensityOc, _IntensityRef, _Saturation, _Contrast, _Brightness;
samplerCUBE _Cube;
